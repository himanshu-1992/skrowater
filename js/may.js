...
xhttp.onreadystatechange = function() {
	if(this.readyState == 4 && this.status == 200) {
		...
		for(var i = 0; i < user.length; i++) {
			...
			showdata += '<h2><h9> Month(May) <br><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Person Name </h9> <br>' + user[i].name + " </h2> ";
...
xhttp.open("GET", "https://script.google.com/macros/s/AKfycbx02Z0J06C3yf51YUw3swFq2z6fi9Dgi2aE_mBHZyMrRrgMUZegYg-BBXyZrkD30z2U/exec", false);
xhttp.send();