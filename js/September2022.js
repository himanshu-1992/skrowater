...
xhttp.onreadystatechange = function() {
	if(this.readyState == 4 && this.status == 200) {
		...
		for(var i = 0; i < user.length; i++) {
			...
			showdata += '<h2><h9> Month(September) <br><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Person Name </h9> <br>' + user[i].name + " </h2> ";
			...
			showdata += '		</tr><td><i class="fa fa-inr" aria-hidden="true"></i> &nbsp;' + user[i].status + '</td>';
			showdata += '	</table>';
			showdata += '</div>';
            showdata += '<div class="amount">';
			showdata += '	<table>';
			showdata += '		<tr  rowspan="5">';
			showdata += '			<th class="amount">Due Amount</th>';
			showdata += '		</tr><td><i class="fa fa-inr" aria-hidden="true"></i> &nbsp;' + user[i].Due_Amount + '</td>';
			showdata += '	</table>';
			showdata += '</div>';
			showdata += '</div>';
			showdata += '</div>';
